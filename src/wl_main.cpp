...
void CheckParameters(int argc, char *argv[])
{
    ...
    {
        printf("Chocolate Wolfenstein 3D\n" // TODO: add version #? author credit?
                                            // site link?
               ...
               " --normal               Sets the difficulty to normal for "
               "tedlevel\n"
               ...
               " --extravbls <vbls>     Sets a delay after each frame, which may "
               "help "
               "to\n"
               "                        reduce flickering (unit is currently 8 ms, "
               "default: 0)\n"
               " --joystick <index>     Use the index-th joystick if available\n"
               "                        (-1 to disable joystick, default: 0)\n"
               " --joystickhat <index>  Enables movement with the given coolie "
               "hat\n"
               ...
               "sound "
               "latency)\n"
               "                        (given in bytes, default: 2048 / (44100 / "
               "samplerate))\n"
               " --ignorenumchunks      Ignores the number of chunks in VGAHEAD.*\n"
               "                        (may be useful for some broken mods)\n"
               " --configdir <dir>      Directory where config file and save games "
               "are stored\n"
#if defined(_WIN32)
               "                        (default: current directory)\n"
#else
               "                        (default: "
               "$HOME/.chocolate_wolfenstein_3d)\n"
#endif
