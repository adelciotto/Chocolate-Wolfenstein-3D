...
void SDL_SetupDigi(void)
{
    ...
    for (i = 0; i < NumDigi; i++)
    {
        ...
        // The original VSWAP contains padding which is included in the page
        // size, but not included in the 16-bit size. So we use the more precise
        // value.
...
////////////////////////////////////////////////////////////////////////////
//
//      SDL_ShutDevice() - turns off whatever device was being used for sound
//      fx
//
////////////////////////////////////////////////////////////////////////////
...
void SD_Startup(void)
{
    ...
    //    YM3812Write(0,8,0); // Set CSM=0 & SEL=0       // already set in for
    //    statement
...
///////////////////////////////////////////////////////////////////////////
//
//      SD_MusicPlaying() - returns true if music is currently playing, false
//      if
//              not
//
///////////////////////////////////////////////////////////////////////////
